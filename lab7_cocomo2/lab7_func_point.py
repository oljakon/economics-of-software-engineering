...
class mywindow(QMainWindow):
    ...
    def onTaskBtnClick(self):
        ...
        fi_levels['Data_trans'] = int(self.ui.Data_trans.currentText()[0])
        fi_levels['Data_proc'] = int(self.ui.Data_proc.currentText()[0])
        fi_levels['Performance'] = int(self.ui.Performance.currentText()[0])
        fi_levels['Exp_limit'] = int(self.ui.Exp_limit.currentText()[0])
        fi_levels['Rate_trans'] = int(self.ui.Rate_trans.currentText()[0])
        fi_levels['Input'] = int(self.ui.Input.currentText()[0])
        fi_levels['Effect_work'] = int(self.ui.Effect_work.currentText()[0])
        fi_levels['Update'] = int(self.ui.Update.currentText()[0])
        fi_levels['Cplx'] = int(self.ui.Cplx.currentText()[0])
        fi_levels['Repeat'] = int(self.ui.Repeat.currentText()[0])
        fi_levels['Easy_inst'] = int(self.ui.Easy_inst.currentText()[0])
        fi_levels['Easy_exp'] = int(self.ui.Easy_exp.currentText()[0])
        fi_levels['Amount_setup'] = int(self.ui.Amount_setup.currentText()[0])
        fi_levels['Agile'] = int(self.ui.Agile.currentText()[0])
        values = fi_levels.values()
        result = sum(values)
        self.ui.sum_atr.setText(str(result))
        #print(result)
        ...
        application_2 = MyWindow(str(round(loc)))
        application_2.show()
